	...
	FitCloudKitManager.onEvent(
		callback = (type : string, data : UTSJSONObject) => {
			if(type != "onLogMessage") {
				__f__('log','at uni_modules/watch-sdk/utssdk/app-ios/index.uts:13',"|||", type, data)
			}
